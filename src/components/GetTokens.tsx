    ...
    async function getTokenAccounts(wallet: string) {
        ...
        try {
            ...
            if(accounts.length === 0) {
                setTokenTable(
                    <div className="text-center py-8 text-lg text-gray-500 dark:text-gray-400">
...
interface ParsedAccountInfo {
      ...
      info: {
        ...
        tokenAmount: {
          uiAmount: number;
                    ...
                    return (
                    <tr key={i+1} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors">
                ...
                const header = (
                  <tr className="bg-gray-50 dark:bg-gray-900 text-gray-500 dark:text-gray-400 uppercase text-xs tracking-wider">
                ...
                setTokenTable(
                  <div className="mt-8 overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 shadow-lg">
    ...
    return (
      ...
      >
        <h2 className="text-3xl font-bold mb-4">Your Token Holdings</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-8">
          Connect your wallet and check all your Solana token accounts
        </p>
        <div className="text-center">
          <button
            className={`px-8 py-4 bg-black dark:bg-white text-white dark:text-black font-bold rounded-full transition-all hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed ${isLoading ? 'animate-pulse' : ''}`}
            onClick={onClick}
